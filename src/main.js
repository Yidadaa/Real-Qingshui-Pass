...
import BJCodePage from "./components/BJCodePage.vue";
...
const router = new VueRouter({
  mode: "hash",
  base:
    process.env.NODE_ENV === "production" ? "Real-Qingshui-Pass" : __dirname,
  routes: [
    {
      path: "/login",
      component: LoginPage,
    ...
    {
      path: "/sq",
      component: SQCodePage,
    },
    {
      path: "/bj",
      component: BJCodePage,
    },
  ],
});
